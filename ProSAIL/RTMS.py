...
def ProSAIL(N, Cab, Car, Cw, Cm, LAI, ALA, Hotspot, rsoil, psoil, tts, tto, psi, bands):
    ...
    fdir = fdir_all_wvl[bands_index]
    soilref = soilref[bands_index]
    ref = np.zeros(bands_index.shape[0], dtype = np.float32)
    for i in range(bands_index.shape[0]):
        ref[i] = SAILHEllip(LAI, ALA, tts, tto, psi, Hotspot,\
            lref[i], ltrans[i], soilref[i], fdir[i])
    return ref

if __name__ == "__main__":
    # for i in range(10000):
    #     print(ProSAIL(2,40, 8, 0.01, 0.01, 3, 60, 0.3, 0.8, 0.2, 30, 0, 0, [450, 550, 670, 840, 1610]))
    # print(".")
    pass